...
const LiveResult = () => {
	...
	return (
		<div className="LiveResultsPage" id="live">
			...
			{data && <div className="mainbadminton">
			...
			{data1  && data1.length > 0 && <div className="mainbasketball">
			...
			{data2 && data2.length > 0 && <div className="mainfootball">
			...
			{data3 && data3.length > 0 && <div className="maincricket">
			...
			{data4 && data4.length > 0 && <div className="maintabletennis">
			...
			{data5 && data5.length > 0 && <div className="mainvollyball">
