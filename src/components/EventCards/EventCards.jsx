							...
							<div className="modalbody">
								<div className="modalDetails">
									...
									<div>
										<p></p>
										<p>Winners: </p>
										<p>{data.prize_money_2}</p>
									</div>
									<div>
										<p></p>
										<p>Runner Up: </p>
										<p>{data.prize_runner_2}</p>
									</div>
								</div>
								<div className="rules">
									<p>Rules:</p>
								...
								<div className="modalShedule">
									...
									{data &&
										data.schedule_2 &&
										data.schedule_2.map((img, id) => {
											return <img src={img} alt="shedule" key={id} />;
										})}
									{(!data.schedule_2 || data.schedule_2.length === 0) && (
										<p>Schedule will be updated soon</p>
									)}
								</div>
								<div className="coordinators">
